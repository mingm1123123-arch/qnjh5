    ...
    <van-dropdown-menu>
      ...
      <van-dropdown-item title="筛选" ref="item">
        ...
        <van-field
          ...
          clickable
          name="picker"
          :value="searchParam.webStatus"
          label="WEB状态"
          placeholder="点击选择WEB状态"
        ...
        <van-field
          ...
          clickable
          name="picker"
          :value="searchParam.webIsLogin"
          label="WEB登录"
          placeholder="点击选择WEB登录"
      ...
      <van-dropdown-item title="操作" ref="userModel">
        <van-tabs v-model="active1">
          <van-tab title="新建用户">
            <van-form @submit="onSubmitAdd">
              ...
              <van-field name="uploader" label="头像">
                <template #input>
                  <van-uploader :max-count="1" v-model="form.avatarList" accept="image/*" :after-read="afterRead" />
                </template>
              </van-field>
              <van-field
              ...
              >
                <template #button>
                  <van-button size="small" type="danger" @click.stop="sendCode">发送验证码</van-button>
                </template>
              </van-field>
          ...
          <van-tab title="新增查看用户">
            <van-form @submit="onSubmitAdd1">
              <van-field
                v-model="form2.phone"
                name="手机号"
                label="手机号"
      ...
      >
        ...
        >
          <div class="goods-item" v-for="item in dataList" :key="item.id">
            ...
            <van-cell title="WEB状态:" :value="item.webStatus_dictText" />
            <van-cell title="APP登录:" :value="item.appIsLogin_dictText" />
            <van-cell title="WEB登录:" :value="item.webIsLogin_dictText" />
            <van-cell title="积分:" :value="item.integral" />
            <van-cell>
              <van-button round block type="danger" @click="goToSeeDetail(item.id)">查看详情</van-button>
            </van-cell>
          </div>
        </van-list>
      </van-pull-refresh>
